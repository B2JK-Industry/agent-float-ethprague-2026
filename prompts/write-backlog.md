...
11. `docs/10-risks.md`
12. GitHub Wiki (`https://github.com/B2JK-Industry/Upgrade-Siren-ETHPrague2026/wiki`). If wiki access fails, continue from local docs and add a clear backlog note that wiki could not be read.
