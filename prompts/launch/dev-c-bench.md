...
- **Trust-discount must be visible.** Source tile shows green dot for verified / amber for unverified. Score breakdown panel shows `× 0.6` factor for every unverified component. GATE-30 is "the structural defense made visible" — if you hide the math, the gate fails.
