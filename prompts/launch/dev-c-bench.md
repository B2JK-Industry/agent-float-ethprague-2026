...
- **S-tier reserved for v2.** v1 P0 max final score is 66 (P1 GitHub signals `null_p1` until US-114b); v1 full max is 79 after US-114b lands. Both cap at tier A; S (≥90) is reserved for verified-GitHub v2. UI tier-S badge is intentionally unreachable in v1 — render it in the tier table with a "v2: requires verified GitHub cross-sign" footnote, never as if a v1 subject could earn it. EPIC Section 10.1 reachable-ceilings table is the spec.
